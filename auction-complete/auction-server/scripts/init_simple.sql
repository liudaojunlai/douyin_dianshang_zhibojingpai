...
VALUES 
(1, '限量版 AirPods Max 星空银', '苹果官方全新未拆封', '["https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=400"]', NOW(), NOW()),
...
-- 插入测试拍卖
INSERT INTO auctions (product_id, seller_id, status, start_price, increment, cap_price, duration, delay_seconds, current_price, start_time, end_time, created_at, updated_at)
VALUES 
(1, 1, 'active', 399900, 1000, 499900, 3600, 10, 429900, NOW(), DATE_ADD(NOW(), INTERVAL 1 HOUR), NOW(), NOW()),
(2, 1, 'active', 299900, 1000, 399900, 7200, 10, 319900, NOW(), DATE_ADD(NOW(), INTERVAL 2 HOUR), NOW(), NOW()),
(3, 1, 'active', 349900, 1000, 449900, 1800, 10, 359900, NOW(), DATE_ADD(NOW(), INTERVAL 30 MINUTE), NOW(), NOW());
